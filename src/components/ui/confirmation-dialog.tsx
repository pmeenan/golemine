  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content className="golemine-dialog-content fixed left-1/2 top-1/2 z-50 w-[calc(100%_-_var(--space-32))] max-w-[var(--layout-dialog-confirm)] rounded-lg border border-border bg-surface-raised p-5 text-text shadow-3">
